                                ...
                                <div class="card-header ">
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-right">
                                                <a href="{{url('agent/campaign/create-campaign')}}" class="btn btn-purple">Add Campaign</a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-bordered mb-0" id="datatableses">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$k->limit}} / day</td>
                                                        <td>
                                                            <a style="width:50px;" href="{{url('agent/campaign/create-campaign/'.$k->id)}}" clas"text-purple">
