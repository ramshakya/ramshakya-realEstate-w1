<table align="center" class="full_width"
    ...
    <tr>
        <td style="text-align:center;  border:hidden;   font-family:Arial, Helvetica, sans-serif;padding: 1px 20px;width: 520px;">
            <div class="safs" style="width:100%;margin:20px 0px">
                <div class="name_convention" align="left">
                    ...
                    <p style="margin-top:30px;">
                        Check out these new MLS properties that meet your search preferences.
                    </p>
                </div>
                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="100%"
                    ...
                    @if(count($listings) > 0 && !empty($listings))
                        @foreach($listings as $listing)
                            ...
                            <table align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
                                   ...
                                   data-bgcolor="Guest Inner">
                                <tbody>
                                <tr style="width: 100%;display: inline-block;clear: both;padding: 30px 0px;border-bottom: #ccc 1px solid;">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="text-align:left;color:#333333; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-weight:600; font-size:20px; line-height:30px;">
                                                    <a href="{{env('WEDUURL')."propertydetails/".$listing["SlugUrl"]}}" style="color: black">{{$listing["StandardAddress"]}}</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                                ...
                                                                <table align="left" bgcolor="#f1c40f" border="0" class="responsive2"
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" valign="middle"
                                                                            class="Heading"
                                                                            style="background-color:#fe9ea1;color:#ffffff; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size:13px; font-weight:bold; letter-spacing:1px; padding:7px 15px;">
                                                                            $ &nbsp;
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="100%"
                        ...
                        <tr>
                            <td align="center">
                                <a href="{{env('WEDUURL')}}{{@$sort_by}}{{@$text_search}}{{@$propertyType}}{{@$baths}}{{@$basement}}{{@$price_min}}{{@$price_max}}{{@$beds}}{{@$Dom}}{{@$features}}{{@$propertySubType}}{{@$shape}}{{@$status}}{{@$sqft}}{{@$curr_bounds}}"
                                   style="background: #c70c0c;color: #fff;padding: 15px 30px;display:inline-block;text-decoration: none;font-weight: 700;">
                                    See More New Listing
                                </a>
                            </td>
                            
                        </tr>
                        <tr>
                            <td align="center" style="color:black;padding:15px 30px;margin:0px;font-size:10px;font-weight:600;" class="responsive4">
                            If you do not wish to get this type of emails click &nbsp;<a href="{{env('WEDUURLUNSUBSCRIBE')}}{{@$emailHash}}" style="color:#f69d9d;display:inline-block;text-decoration:none;font-weight:700;font-size:12px;margin-top:10px;" target="_blank"> <u> Unsubscribe </u> </a>  {{@$websiteTitle}} 
                            </td>
                        </tr>
                        </tbody>
                    </table>
