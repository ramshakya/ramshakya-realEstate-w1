                            ...
                            <div class="card-header ">
                                <div class="row">
                                    ...
                                    <div class="col-2 text-right">
                                        @if(@$showAll)
                                        <a href="{{url('agent/staff/')}}" class="btn btn-success">Active Staff</a>
                                        @else
                                        <a href="{{url('agent/staff/inactivestaff')}}" name="Show" class="btn btn-danger">Inactive Staff</a>
                                        @endif
                                    </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered mb-0 text-center" id="datatableses">
                                            <thead>
                                            <tr>
                                                <th colspan="">Sr. No</th>
                                                <th colspan="" >Name</th>
                                                ...
                                                @foreach(@$agents as $k)
                                                    <tr>
                                                        ...
                                                        <td>@if(@$showAll)
                                                            ...
                                                            @else
                                                            <?php if(auth()->user()->person_id == 1) { ?>  <a href="{{url('super-admin/staff/add/'.$k->id)}}" class="text-info"><i class="fa fa-edit"></i></a>
