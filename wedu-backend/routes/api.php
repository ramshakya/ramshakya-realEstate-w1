...
Route::any('testprc', [TestController::class, 'propertiesDetaillsNew']);
Route::any('testPropertyDetails', [PropertiesController::class, 'propertiesDetailsRecon']);
Route::get('redirect', [SocialController::class, 'redirect'])->name('redirect');
Route::get('googleCallBack', [SocialController::class, 'callback'])->name('callback');
...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['prefix' => 'agent'], function () {
        ...
        Route::group(['prefix' => 'events'], function () {
            ...
            Route::post('/getSlots', [EventController::class, 'getSlots'])->middleware('Apivalidationsecurity');
            Route::post('/addSlots', [EventController::class, 'addSlots'])->middleware('Apivalidationsecurity');
        });
        ...
        Route::post('/Notifications', [MainAgentController::class, 'Notifications'])->middleware('Apivalidationsecurity');
    });
    ...
    Route::group(['prefix' => 'services'], function () {
        ...
        Route::post('login', [UserLogin::class, 'loginAgent'])->middleware('Apivalidationsecurity');
        ...
        // user register
        Route::post('register', [UserLogin::class, 'register'])->middleware('Apivalidationsecurity');
        Route::post('loginSocial', [UserLogin::class, 'loginSocial'])->middleware('Apivalidationsecurity');
        ...
        Route::post('userActivity', [UserLogin::class, 'userActivity'])->middleware('Apivalidationsecurity');
        ...
        Route::post('SubmitHomeValue', [HomeController::class, 'SubmitHomeValue'])->middleware('Apivalidationsecurity');
        Route::post('GetStaffs', [HomeController::class, 'GetStaffs'])->middleware('Apivalidationsecurity');
        Route::post('GetBlogs', [HomeController::class, 'GetBlogs']);
        Route::post('GetBlogTitle', [HomeController::class, 'GetBlogTitle']);
        Route::post('GetBlogCategory', [HomeController::class, 'GetBlogCategory'])->middleware('Apivalidationsecurity');
        ...
        Route::group(['prefix' => 'bootstrap'], function () {
            ...
            Route::any('/filterData', [PropertiesController::class, 'filterData'])->middleware('Apivalidationsecurity');
        });
        // New Routes By Ram
        Route::group(['prefix' => 'search'], function () {
            ...
            Route::any('/suggestionSearch', [PropertiesController::class, 'getAutoSearchResults']);
            Route::any('/getDataFromYelp', [PropertiesController::class, 'getDataFromYelp']);
            Route::post('/mapSearchList', [SearchController::class, 'mapSearchList'])->middleware('Apivalidationsecurity');
            Route::post('/mapBoundary', [SearchController::class, 'mapBoundary'])->middleware('Apivalidationsecurity');
            Route::post('/mapSearchMarkers', [SearchController::class, 'mapSearchMarkers'])->middleware('Apivalidationsecurity');
            // Route::post('/mapSearchTotal', [SearchController::class, 'mapSearchTotal']);

        });
        //
        // property-details
        Route::group(['prefix' => 'fetchPageViews', 'middleware' => ['Apivalidationsecurity']], function () {
            Route::any('/propertyDetails', [PropertiesController::class, 'propertiesDetails'])->withoutMiddleware('Apivalidationsecurity');
            //Route::any('/propertyDetails', [TestController::class, 'propertiesDetaillsNew']);
            Route::any('/similarProperty', [PropertiesController::class, 'similarProperty']);
            Route::any('/listingHistory', [PropertiesController::class, 'listingHistory']);

            Route::post('/soldData', [PropertiesController::class, 'soldData']);
            Route::post('/similarSaleProperty', [PropertiesController::class, 'similarSaleProperty']);
            Route::post('/similarRentProperty', [PropertiesController::class, 'similarRentProperty']);

        });

        // home page routes
        Route::group(['prefix' => 'home'], function () {
            Route::any('/getBlogs', [HomeController::class, 'getBlog'])->middleware('Apivalidationsecurity');
        ...
        Route::group(['prefix' => 'global'], function () {
            Route::get('/getProperties', [HomeController::class, 'getProperties'])->middleware('Apivalidationsecurity');
            ...
            Route::any('/webSettings', [HomeController::class, 'webSettings'])->middleware('Apivalidationsecurity');
            ...
            Route::post('DeleteFavouriteProperty', [FrontendGetProperty::class, 'DeleteFavouriteProperty']);
            Route::post('getFavouriteProperties', [FrontendGetProperty::class, 'getFavouriteProperties'])->middleware('Apivalidationsecurity');
            ...
            Route::any('/marketStatsFilterData', [HomeController::class, 'marketStatsFilterData'])->middleware('Apivalidationsecurity');
            Route::any('/domAvgMedian', [HomeController::class, 'domAvgMedian'])->middleware('Apivalidationsecurity');
            Route::any('/Market_states', [HomeController::class, 'Marketstates'])->middleware('Apivalidationsecurity');
            Route::any('/soldActive', [HomeController::class, 'soldActive'])->middleware('Apivalidationsecurity');
            Route::any('/medianRental', [HomeController::class, 'medianRental'])->middleware('Apivalidationsecurity');
            Route::any('/propertyTyprDist', [HomeController::class, 'propertyTypeDistribution'])->middleware('Apivalidationsecurity');
            Route::any('/absorptionData', [HomeController::class, 'absorptionData'])->middleware('Apivalidationsecurity');
            Route::any('/getSoldByAgent', [HomeController::class, 'getSoldByAgent'])->middleware('Apivalidationsecurity');
        });
    });
});
