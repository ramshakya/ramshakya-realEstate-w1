...
class LeadAgent extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('LeadAgentProfile', function (Blueprint $table) {
            $table->text('Reqsent');
            ...
            $table->datetime('GtokenAddedAt');
            $table->datetime('GtokenUpdatedAt');
    ...
    {
        //
        Schema::dropIfExists('LeadAgentProfile');
    }
}
