...
class CreateRetsPropertyDataCondosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rets_property_data_condo', function (Blueprint $table) {
            $table->id();
            $table->string('Den_fr', 50)->nullable();
            $table->string('Disp_addr', 1)->nullable();
            $table->decimal('Dom', 5, 0);
            ...
            $table->text('Net_inc')->nullable();
            $table->text('Oa_area')->nullable();
            ...
            $table->string('Insur_bldg', 50)->nullable();
            ...
            $table->string('Secgrd_sys', 50)->nullable();
            $table->string('Share_perc', 6)->nullable();
            ...
            $table->string('Unit_num', 4)->nullable();
            ...
            $table->string('Bldg_amen1_out', 50)->nullable();
            $table->string('Bldg_amen2_out', 50)->nullable();
            $table->string('Bldg_amen3_out', 50)->nullable();
            $table->string('Bldg_amen4_out', 50)->nullable();
            $table->string('Bldg_amen5_out', 50)->nullable();
            $table->string('Bldg_amen6_out', 50)->nullable();
            $table->decimal('Br');
            ...
            $table->string('Cond_txinc', 50)->nullable();
            ...
            $table->string('Locker', 50)->nullable();
            $table->string('Locker_num', 4)->nullable();
            ...
            $table->string('Locker_lev_unit', 3)->nullable();
            $table->string('Locker_unit', 4)->nullable();
    ...
    {
        Schema::dropIfExists('rets_property_data_condo');
    }
}
