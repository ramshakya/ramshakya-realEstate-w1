...
<html lang="en">
    ...
    <head>
        ...
        <title>Peregrine &mdash; Manage your agents and realtors, your freedom</title>
...
<header>
    <h2><a href="#">Peregrine!</a></h2>
    <nav>
        <li><a href="{{env('APP_URL')}}" target="_blank">Properties</a></li>
...
<section class="hero">
    ...
    <div class="hero-content-area">
        ...
        <h3>Experience Sales of Realtors</h3>
        <!-- <a href="{{url('super-admin/')}}" class="btn">SuperAdmin Login</a> -->
        <a href="{{url('agent/')}}" class="btn">Agent Login</a>
    </div>
</section>
