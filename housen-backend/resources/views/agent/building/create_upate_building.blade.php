                            ...
                            <div class="card-header ">
                                <div class="row">
                                    ...
                                    <div class="col-4 text-right">
                                        <a href="{{url('agent/building/')}}" class="btn btn-purple">All Building List</a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form class="pro-add-form" id="PreConstuctionForm" method="POST" action="" enctype="multipart/form-data">
                                        ...
                                        <div id="accordion">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-lg-6">
                                                                ...
                                                                <!--<input type="text" class="form-control" id="Community" name="Community" placeholder="Community" value="">-->

                                                            <label for="Subclass" class="mt-2">Building logo</label>
                                                            @if(@$PreConstruction->BuildingLogo)
                                                                <img src="{{@$PreConstruction->BuildingLogo}}" width="100px">
                                                                @endif
                                                                <input type="file" name="BuildingLogo" id="BuildingLogo" class="form-control">

                                                                <input type="hidden" class="form-control" id="Slug" name="Slug" required="" placeholder="Slug" value="{{@$PreConstruction->Slug}}" readonly>
                                                            <!--  <label for="Subclass" class="mt-2">Addr_info</label>
                                                             ...
                                                             <div class="col-md-6 col-lg-6">
                                                                <label for="Subclass" class="mt-2">Add to latest or comming soon </label>
                                                                <div>
                                                                <label><input type="radio" name="LatestOrComminSoon" @if(@$PreConstruction->LatestOrComminSoon==1)checked @endif value="1"/> Latest</label>
                                                                &nbsp;&nbsp;<label><input type="radio" name="LatestOrComminSoon" @if(@$PreConstruction->LatestOrComminSoon==0)checked @endif value="0" /> Comming Soon</label>
                                                                 &nbsp;&nbsp;<label><input type="radio" name="LatestOrComminSoon" @if(@$PreConstruction->LatestOrComminSoon==2)checked @endif value="2"/> None </label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                </div>
                                                ...
                                                <?php $build_status = array('Purposed','Under Construction','Ready to Move','Registration');?>
                                                                <option value="">Select</option>
                                                    ...
                                                    @endforeach
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            ...
                                                            <input type="text" class="form-control" id="SizeRange" name="SizeRange" placeholder="Size Range" value="{{@$PreConstruction->SizeRange}}">
                                                        </div>

                                                        <div class="col-md-6 col-lg-6">
                                                            <label class="mt-2">Price Range</label>
                                                            <input type="text" class="form-control" id="PriceRange" name="PriceRange" placeholder="Price Range" value="{{@$PreConstruction->PriceRange}}">
                                                        </div>
                                                        ...
                                                        <div class="col-md-6 col-lg-6">
                                                            <label class="mt-2">Architects</label>
                                                            <input type="text" class="form-control" id="Architects" name="Architects" placeholder="Architects" value="{{@$PreConstruction->Architects}}">
                                                        </div>

                                                        <div class="col-md-6 col-lg-6">
                                                            <label class="mt-2">Completion Year</label>
                                                            <input type="text" class="form-control" id="Completion" name="Completion" placeholder="Completion Year" value="{{@$PreConstruction->Completion}}">
                                                        </div>
                                                        <div class="col-md-6 col-lg-6">
                                                            <label class="mt-2">Brochure </label>
                                                            <input type="file" class="form-control File_submitted" accept="application/pdf" id="Brochure" name="Brochure">
                                                            @if(@$PreConstruction->Brochure)
                                                                <div class="File_span1"><?php echo $PreConstruction->Brochure = trim($PreConstruction->Brochure, env('APP_URL')."storage/"); ?></div>
                                                            @endif
                                                        </div>
                                                        <div class="col-md-6 col-lg-6">
                                                            <label class="mt-2">Feature & Finishes </label>
                                                            <input type="file" accept="application/pdf" class="form-control File_submitted" id="Feature_and_Finishes" name="Feature_and_Finishes">
                                                            @if(@$PreConstruction->Feature_and_Finishes)
                                                                <div class="File_span2"><?php echo $PreConstruction->Feature_and_Finishes = trim($PreConstruction->Feature_and_Finishes, env('APP_URL')."storage/"); ?></div>
                                                            @endif
                                                        </div>
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <p class="hint">First photo will be displayed as a primary photo<br>Use CTRL to select multiple photos</p>
                                                        <label class="form__container text-center" id="upload-container">Choose an image file or Drag it here <br>Max file size 20MB
                                                ...
                                                <h4>Attechments / Floor Plan<i class="fas fa-sort-down downBtn"></i></h4>
                                                </div>
                                                <div id="collapseFive" class="collapse">
                                                <div class="card-body">
                                                    <label class="form__container text-center" id="upload-container1">Choose an image file or Drag it here <br>Max file size 20MB
...
@section('pageLevelJS')
    ...
    <script type="text/javascript">
       const INPUT_FILE_Pdf1 = document.querySelector('#Brochure');
        INPUT_FILE_Pdf1.addEventListener('change', () => {
            if($('#Brochure').val()!=""){
                $('.File_span1').css("display","none");
            }
        })
        const INPUT_FILE_Pdf2 = document.querySelector('#Feature_and_Finishes');
        INPUT_FILE_Pdf2.addEventListener('change', () => {
            if($('#Feature_and_Finishes').val()!=""){
                $('.File_span2').css("display","none");
            }
        })
    </script>
