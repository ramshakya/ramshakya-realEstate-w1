                                            ...
                                            @if($page_list)
                                                @foreach($page_list as $page)
                                                    <tr>
                                                        ...
                                                        <td><a href="{{url('agent/pages/create-page/'.$page->id)}}" class="text-info" title="Edit">
                                                                <i class="fa fa-edit"></i>
                                                            </a>&nbsp;&nbsp;
                                                            <a href="{{url('agent/pages/edit-code/'.$page->id)}}" class="text-success" title="Write code">
                                                                <i class="fa fa-file-code"></i>
                                                            </a>&nbsp;&nbsp;
                                                            @if(!$page->CreatedBy)
                                                                <a href="#"
                                                                   onclick="get_delete_value('{{$page->id}}}','pages')"
