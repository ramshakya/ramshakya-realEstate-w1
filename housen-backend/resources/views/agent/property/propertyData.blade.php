                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    @foreach($PropertySubType as $SubType)
                                                        <option value="{{$SubType->PropertySubType}}"><b>{{$SubType->PropertySubType}}</b></option>
                                                    @endforeach
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                            ...
                                                            <input type="text" id="userinput1" class="form-control search_input_one " name="search" placeholder="Search MLS , Address , List Price" value="">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                    <label>Cities</label><br>
                                                    <select class="select2 select2-multiple" multiple="multiple" data-placeholder="Choose ..." id="cities">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control"  data-placeholder="Choose ..." id="beds">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control"  data-placeholder="Choose ..." id="Baths">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control"  data-placeholder="Choose ..." id="Area_min_size">
                                                        <option value="">Min size</option>

                                                        @for($min_sq= 500; $min_sq<=4000;$min_sq+=500)
                                                            <option value="{{$min_sq}}">{{$min_sq}} Sq.Ft.</option>
                                                        @endfor
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <select class="form-control"  data-placeholder="Choose ..." id="Area_max_size">
                                                ...
                                                <div class="col-md-10">
                                                    <div id="accordion">
                                                        <div class="card">
                                                            <div class="card-header feature_collapse" data-toggle="collapse" href="#collapseOne">
                                                              <b>Features</b> <i class="fas fa-sort-down down_icon"></i>
                                                            </div>
                                                            ...
                                                            @foreach($features_master as $key=> $feature)
                                                                    <div class="col-md-3">
                                                                         <label for="features{{$key}}">
                                                                        <input type="checkbox" class="features" id="features{{$key}}" value="{{$feature->id}}"/> {{$feature->Features}}</label>
                                                                    </div>
                                                            @endforeach
                                                                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="model-head">
                    <button type="button" class="close bg-danger text-white" data-dismiss="modal" aria-label="Close" style="right:20;right: 20 !important;margin-right: 10px;margin-top: 5px;border-radius: 30px;padding: 2px 8px;">
