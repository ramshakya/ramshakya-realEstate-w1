                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="text-align:left;color:#333333; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-weight:600; font-size:20px; line-height:30px;">
                                                    <a href="{{$fronendUrl."/propertydetails/".$listing["SlugUrl"]}}" style="color: black">{{$listing["StandardAddress"]}}</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td align="left" class="Heading"
                                                                    ...
                                                                    data-color="Guest Heading"
                                                                    data-size="Guest Heading" data-min="15"
                                                                    data-max="42">
