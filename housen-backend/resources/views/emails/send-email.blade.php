<?php
$data = \App\Models\SqlModel\Websetting::where("AdminId", '=', 2)->first();
$emailAddress = $data->WebsiteEmail;
$phone = $data->PhoneNo;
$websiteTitle = $data->WebsiteTitle;
$websiteLogo = $data->DarkLogo?$data->DarkLogo:env('APP_URL')."/logo/Housen.ca.png";
...
$appName = "<a href='".env('APP_NAME')."' target='_blank' >".ucfirst($appName)."</a>";
?>
        ...
        <table
            ...
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                                                        ...
                                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                                            <tr>
                                                                <td class="v-text-align"
                                                                    ...
                                                                    align="center">
                                                                    <a href="{{env('HOUSENFRONTURL ')}}" target="_blank">
                                                                        <img align="center" border="0"
                                                                             src="{{$websiteLogo}}"
                                                                             alt="HOUSEN.CA" title="{{$websiteLogo}}"
                    ...
                    <div class="u-row-container mobile_width_grey" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                             style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #0072a4;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                <!--[if (mso)|(IE)]>
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding: 0px;background-color: transparent;" align="center">
                                        <table cellpadding="0" cellspacing="0" border="0" style="width:600px;">
                                            <tr style="background-color: #0072a4;"><![endif]-->
                    ...
                    <div class="u-row-container mobile_width_content" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <table id="u_content_text_2" style="font-family:'Rubik',sans-serif;"
                                                ...
                                                <tr>
                                                    <td class="v-container-padding-padding"
                                                        style="overflow-wrap:break-word;word-break:break-word;/*padding:40px 8px 50px;*/font-family:'Rubik',sans-serif;"
                                                        align="left">

                                                        <div class="v-text-align"
                                                             style="color: #5c5c5c; line-height: 170%; text-align: left; word-wrap: break-word;padding:1px 10px;">
                                                    ...
                                                    <td class="v-container-padding-padding"
                                                        ...
                                                        <div class="v-text-align"
                                                            ...
                                                            <p style="font-size: 14px; line-height: 180%;"><span
                                                                    style="font-family: Raleway, sans-serif; font-size: 14px; line-height: 25.2px;">You have received this email because you have saved listing alerts/community watch or registered on <?php echo $appName; ?>. If you do not wish to receive these updates/offers/promotional communication you may change your preferences on <?php echo $appName; ?> or simply unsubscribe </span>
                                                            </p>
                                                            <p style="font-size: 14px; line-height: 180%;"><span
                                                                    style="font-family: Raleway, sans-serif; font-size: 14px; line-height: 25.2px;">&copy;2022 <?php echo $appName; ?> | {{$address}}</span>
                                                            </p>
                                                        </div>
