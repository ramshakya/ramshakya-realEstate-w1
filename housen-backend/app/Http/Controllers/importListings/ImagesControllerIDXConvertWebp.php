                    ...
                    if (count($photos) > 0) {
                        ...
                        foreach ($photos as $key => $photo) {
                            if ($photo["Success"]) {
                                ...
                                //create webp image
                                //Resize
                                $target_file = "/var/www/html/searchrealtycrm/storage/app/public/img/mls_images/".$className."/Photo-". $mlsId . "_" . $key . "340x220.jpeg";                          
                                $this->load('/var/www/html/searchrealtycrm/storage/app/public/img/'.$img_dir );
                                $this->resize(340, 220);
