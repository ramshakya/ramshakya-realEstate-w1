...
class PropertyController extends Controller
{
    ...
    public function index() {
            ...
            $data['features_master']=FeaturesMaster::limit(100)->get();
            //
            $price = 25000;
            $price_array=[];
            $increase = 10000;
          ...
          if( isset($request->token) && !empty($request->token) ){
              ...
              if($token->login_user_id){
                  ...
                  if( isset($apikey) && !empty($apikey) && $apikey==$ApiKeyData){
                      ...
                      $query=PropAddressFilterSql::where('County',$county)->where('CustomPropertyType',$CustomPropertyType);
//                      return $listingId;
