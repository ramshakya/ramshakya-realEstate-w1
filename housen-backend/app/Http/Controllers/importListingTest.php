...
use App\Models\PropertyAddressDataTest;
use App\Models\SqlModel\FeaturesMaster;
use App\Models\SqlModel\PropertyFeatures;
use Illuminate\Support\Facades\DB;
use App\lib\phrets;
use App\Models\RetsPropertyDataTest;
use Illuminate\Support\Facades\Schema;
use Illuminate\Http\Request;

class importListingTest extends Controller
{
    //
    public $mls_config;
    ...
    public function importPropertyListingTest()
    {
        $rets_prop_mapping = [
            "Disp_addr" => "Disp_addr",
            "Dom" => "Dom",
        ...
        $cron_tablename = "PropertiesCronLogTest";
        $file_name = "ListingsControllerIDXImport";
        ...
        foreach ($all_mls as $curr_mls_id => $curr_mls) {
            ...
            foreach ($property_class as $className => $classconfig) {
                ...
                $property_table_name ="RetsPropertyDataResiTest";
                ...
                if ($diff > 3600 * 24 * 5) {
                    $new_starttime = strtotime("+5 day", $old_timestamp);
                }
...
//                                }
                            ...
                            $result = RetsPropertyDataTest::updateOrCreate(["ListingId" => $record[$key_field]], $rets_property_data);
                            $time_end = microtime(true);
                            $execution_time = ($time_end - $time_start);
                            echo '<b>Total Execution Time:</b> '.$execution_time;
                            if($properties_inserted_in_db >101){
                                exit;
                            }
                            continue;
                            ...
                            $addressResult =  DB::table("PropertyAddressDataTest")->updateOrCreate(['ListingId'=>$rets_property_data["ListingId"]],$addressData);
