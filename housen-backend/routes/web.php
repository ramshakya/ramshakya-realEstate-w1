...
use App\Http\Controllers\importListingTest;
...
Route::get("/Testimport", [importListingTest::class, 'importPropertyListingTest']);

Route::get("/twilio/test/{id?}", [\App\Http\Controllers\TestController::class, 'TwilioTest']);
Route::get("/deleteComm", [\App\Http\Controllers\TestController::class, 'deleteCommImages']);
...
Route::prefix('agent')->group(function () {
    ...
    Route::any('/list', '\App\Http\Controllers\agent\LeadAgentController@index')->middleware('is_agent');
    ...
    Route::prefix('testimonial')->group(function () {
        ...
        Route::any('/edit-testimonial/{id?}', '\App\Http\Controllers\agent\TestimonialController@addTestimonial')->middleware('is_agent');
    });

    Route::prefix('property')->group(function () {
        Route::any('/', '\App\Http\Controllers\agent\property\PropertyController@index')->middleware('is_agent');
        Route::any('/bulk-import', '\App\Http\Controllers\agent\property\PropertyController@BulkImport')->middleware('is_agent');
    ...
    Route::prefix('building')->group(function () {
        ...
        Route::any('/create-update-building', '\App\Http\Controllers\agent\ConstructionBuilding@create_update_building')->middleware('is_agent');
        Route::any('/create-update-building/{id?}', '\App\Http\Controllers\agent\ConstructionBuilding@create_update_building')->middleware('is_agent');
        ...
        Route::any('/add-edit-builder/{id?}', '\App\Http\Controllers\agent\ConstructionBuilding@add_edit_builder')->middleware('is_agent');
        Route::any('/amenities-list', '\App\Http\Controllers\agent\ConstructionBuilding@amenity_list')->middleware('is_agent');
        Route::any('/add-edit-amenities', '\App\Http\Controllers\agent\ConstructionBuilding@add_edit_amenities')->middleware('is_agent');
        Route::any('/add-edit-amenities/{id?}', '\App\Http\Controllers\agent\ConstructionBuilding@add_edit_amenities')->middleware('is_agent');
    });
});
...
Route::prefix('super-admin')->group(function () {
    ...
    Route::prefix('property')->group(function () {
        Route::any('/', [\App\Http\Controllers\superAdmin\AgentController::class, 'getProperty'])->middleware('auth');
    });
