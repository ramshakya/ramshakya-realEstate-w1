...
var editMenuItem = function () {
    ...
    target.find("> .dd-handle > a").html(newName);
    target.find("> .dd-handle > a").attr("href",baseurl+newSlug);
...
//var newIdCount = 1;
var newIdCount = Math.floor((Math.random() * 1000000) + 1);
...
var addToMenu = function () {
    ...
    nestableList.append(
        '<li class="dd-item nav-item dropdown" ' +
        'data-id="' + newId + '" ' +
        'data-name="' + newName + '" ' +
        'data-slug="' + newSlug + '" ' +
        'data-new="1" ' +
        'data-deleted="0">' +
        '<div class="dd-handle"><a class="nav-link header_grid_color" href="' +baseurl+newSlug + '">' + newName + '</a></div> ' +
...
;(function($, window, document, undefined)
{
    ...
    var defaults = {
        ...
        itemNodeName    : 'li',
        rootClass       : 'dd',
        listClass       : 'dd-list dd_list_nestable',
        itemClass       : 'dd-item nav-item dropdown',
        dragClass       : 'dd-dragel',
