...
class Mapload extends React.Component {
    constructor(props) {
        ...
        // console.log("==mapdiv===>props>>mapdata", props);
        this.state = {
    ...
    componentDidMount() {
        ...
        if (mapdata) {
            ...
            //console.log("data for marker", mapdata);
        }
    ...
    showMarkers() {
        ...
        var cntr = 0;
        if (lnth) {
            cntr = Math.ceil(Math.random() * lnth)
        }
            ...
            <div className={Style.containerSection}>
                <div className="row">
                    ...
                    <div className="col-md-6">
                        ...
                        <div ref={e => this.mapDiv = e} className={Style.map}>
                            <button className={Style.vUlx} onClick={this.polygonClick} id="btn_draw" title="Draw On Map">
                                <div className={Style.hXsNXu}>
                                    <span>Draw</span></div>
                            </button>
                            <button name="" className={Style.bfsJGf} onClick={this.clearDrawArea} id="clear_draw" style={{ "display": "none" }}>Clear Map Bounds</button>
                        </div>
                    </div>
                    <div className={`col-md-6`}>
