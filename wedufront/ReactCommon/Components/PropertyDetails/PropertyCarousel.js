                ...
                <div className="w-100 h-100 position-relative">
                  {this.props.propertyImage[0] &&
                    <img
                      ...
                      title={this.props.propertyImage[0].s3_image_url}
                      layout={'fill'}
                      // alt="Property-Detail"
                      alt={this.props.alt}
                      objectFit={"cover"}
    ...
    const data = firstSliderArr.map((img, index) => {
      ...
      return (
        ...
        >
          <div className="w-100 h-100 position-relative" >
            <img
              src={img.s3_image_url ? Constant.image_base_url + img.s3_image_url : Constant.defaultImage}
              title={img.s3_image_url ? img.s3_image_url : Constant.defaultImage}
              layout={'fill'}
              alt={this.props.alt}
              objectFit={"cover"}
              onClick={() => {
                      ...
                      <div className="d-flex justify-content-center" key={k}>
                        <div className="w-75">
                          <img
                            ...
                            title={image.s3_image_url ? image.s3_image_url : Constant.defaultImage}
                            alt={props.alt}
                            style={{
                              width: "",
