                ...
                <div className="card-content">
                    ...
                    <span className="spec" title="Bedrooms">
                        {getRound(data.BedroomsTotal) &&
                            <span>
                                {getRound(data.BedroomsTotal)} {' '}
                                <img src="../images/icons/bed.svg" height={20} width={20} alt="bath-icon" className="prop-icons opacity-cls" />
                            </span>
                        }
                    </span>
                    {getRound(data.BathroomsFull) &&
                        <span className="spec" title="Bathrooms">
                            {getRound(data.BathroomsFull)} {'  '}
                            <img src="../images/icons/bath.svg" height={20} width={20} alt="bath-icon" className="prop-icons opacity-cls" />
                        </span>
                    }
                    {
                        data.isMarker ? "" : <>
                            {data.Sqft &&
                                <span className="spec area-sqft-cls" title="Area Sqft">
                                    {data.Sqft}{' '}
                                    <img src="../images/icons/square.svg" height={20} width={20} alt="sqft-icon" className="prop-icons opacity0-5-cls" /><sup>2</sup>
                                </span>
                            }
                        </>
                    }
