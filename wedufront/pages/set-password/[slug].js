        ...
        <div className="row pt-5">
          ...
          <div className="col-md-4 col-lg-4">
            {tokenExist === "success" && (
              <form className="set-password-box" onSubmit={handleSubmit}>
                ...
                <div className="form-group mb-2">
                  ...
                  <input
                    type="password"
                    className="form-control forgot-psd"
                    id="password"
                    name="password"
                    onKeyUp={handleInput}
                  />
                  <span className="err-inp-msg" id="msg1">
                    {errorMsg}
                  </span>
                </div>
                <div className="form-group pb-3">
                  ...
                  <input
                    ...
                    onKeyUp={handleInput}
                  />
                  <span className="err-inp-msg" id="msg2">
                    {confirm}
                  </span>
                </div>
                <button
            ...
            {tokenExist === "Session Expired" && (
              <div className="page-expired text-center">
                <h3>
                  Session Expired!
                  <br />
