...
// Components
// import RedButton from "../../components/Button/RedButton.js";
// import WhiteButton from "../../components/Button/WhiteButton.js";
// import CardRow from "../Card/CardRow.js";
import CardRow from "../../ReactCommon/Components/MapCard";
// import FormSort from "../../components/FormSort/FormSort.js";
// Data
import { sortItem } from "../../data/SortItem.js";
import { cardData } from "../../data/CardDataItems.js";
import CardFluid from "../../components/Card/CardFluid.js";
...
const PropertyType = (props) => {
  ...
  useEffect(() => {
    ...
    const fetchProperties = async () => {
      ...
      initialPropertySearchFilter["propertySubType"] = [slugs];
      ...
      console.log("====>>>>initialPropertySearchFilter", initialPropertySearchFilter);
    ...
    <div className="custom-padding mt-3">
      <Container>
              ...
              <p className=""><b>Community:</b> <span style={{ 'color': 'var(--grey)' }}>
                {array1.map((item, index) => {
                  ...
                  if (item !== '') {
                    ...
                    return (
                      <Link href={'/area/' + item} key={index + 'community'}>
        ...
        <Row className="mb-2">
          ...
          >
            <WhiteButton className="d-inline-block view-page-counter border btn-active">
              12
            </WhiteButton>
            <WhiteButton className="d-inline-block view-page-counter border ">
              24
            </WhiteButton>
            <WhiteButton className="d-inline-block view-page-counter border ">
              48
