                ...
                <div className="row">
                    <div className="col-lg-12">
                        <h1 className="heading-text text-center">
                            Buying Real Estate ?
                           <center> <hr className="hr" width="350" /></center>
                        </h1>
                    </div>
                </div>
            </div>
            <section className="homeValue" style={{ backgroundImage: `url(../images/homevalue.jpg)` }}>
                    ...
                    <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                ...
                                <h5>Thinking of selling or interested in
                                    learning about a neighbor's house? We can
                                    help you see what it's worth.</h5>
                            </div>
                            <div className="col-md-10 col-lg-10 pt-4">
                                <form className="searchForm row" onSubmit={handleSubmit}>
                                    <div className="col-lg-8 colmd-8">
                                        <input type="text" name="searchinput" className="form-control py-2"
                                    ...
                                    <div className="col-lg-4 colmd-4">
                                        <button className="common-btn search-btn py-2 rounded">Show me now!</button>
                                    </div>
