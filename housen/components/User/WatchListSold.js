	...
	return (
		<>
			<div className="watchlisting row">
				{/*<Listings {...props} heading="" removeCb={deleteFunction} isTrash={true} propertyData={watchedList} imageData={[]} isSold={true} isWatch={true} LoginRequired={0} />*/}
