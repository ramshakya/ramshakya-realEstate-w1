                ...
                <Col lg={6}>
                  <div
                    ...
                    style={{
                      ...
                      // 'backgroundImage': 'url(' + Constants.image_base_url +
                      // this.props.propertyImage[0].s3_image_url + ')'
                    }}
                  >
                    <Card className="mt-9">
                        ...
                        >
                          <div>
                            ...
                            <ul className="LoginBenefit sliderLoginBox-list">
                              ...
                              <li>
                                Save Homes & Searches, Add Listing/Community
                                Watch Alerts
                              </li>
                            </ul>
  ...
  return (
    <div className="position-fixed property-popup">
      <div className="position-relative">
        <div
          className=" position-absolute text-white d-flex flex-row-reverse padding30 opacity-0 cursor-pointer"
          onClick={() => {
            props.handleClose();
          }}
        >
