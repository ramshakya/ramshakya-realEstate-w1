            ...
            return roomdata.map((data, index) => {
                if (data.isHeading) {
                    return (
                        <>
                            <thead key={index} >
                                <tr className="headings" key={index} >
                ...
                return (
                    <>
                        <tbody key={index}>
                            <tr className={`${data.levels?"trHead":""}`} key={index}>
                                <td className="rooms-heading">{data.levels}</td>
                                <td className="rooms-heading">{data.name}</td>
                                {
                                    props.isShow ? <td id="list_detroom_meter" >{data.sizeInMt}</td> : <td id="list_detroom_feet" className="" >{data.sizeInFt}</td>
                                }
                                <td>{data.desc}</td>
                            </tr>
                        </tbody>
